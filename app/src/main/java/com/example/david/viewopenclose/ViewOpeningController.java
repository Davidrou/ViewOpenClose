 ...
 * @author pan peng fei
 */
public abstract class ViewOpeningController implements Animation.AnimationListener {
	private View view;
	...
	public void measureViewHeightAndInit(boolean opened){
		...
		if(view.getVisibility() != View.GONE){
			view.measure(
					View.MeasureSpec.makeMeasureSpec(fillParent, View.MeasureSpec.EXACTLY),
